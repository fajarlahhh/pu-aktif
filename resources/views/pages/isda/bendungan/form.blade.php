            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control selectpicker" name="bendungan_tahun_pembuatan" id="bendungan_tahun_pembuatan" data-live-search="true" data-style="btn-info" data-width="100%">
                            @for ($i = date('Y'); $i >= 1970; $i--)
                            <option value="{{ $i }}" {{ $aksi == 'edit' && $data->bendungan_tahun_pembuatan == $i? 'selected': '' }}>{{ $i }}</option>
                            @endfor
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="bendungan_kelas" value="{{ $aksi == 'edit'? $data->bendungan_kelas: old('bendungan_kelas') }}" required data-parsley-minlength="1" data-parsley-maxlength="250" autocomplete="off"  />
                    </div>
                    <div class="form-group">
