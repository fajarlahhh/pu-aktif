        ...
        <div class="row">
            <div class="col-md-2 col-lg-2 col-xl-2 col-xs-12">
                ...
                <div class="form-inline">
                    <a href="{{ route('bendungan.tambah') }}" class="btn btn-primary"><i class="fad fa-plus"></i> Tambah</a>
                </div>
                @endrole
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="{{ route('bendungan.edit', array('id' => $row->barang_dan_pekerjaan_id)) }}" class="m-2"><i class='fad fa-edit fa-lg text-blue-darker'></i></a>
