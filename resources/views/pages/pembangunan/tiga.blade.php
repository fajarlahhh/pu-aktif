        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav-items">
                <a href="#default-tab-2" data-toggle="tab" onclick="initMap()" class="nav-link">
                    ...
                    <span class="d-sm-block d-none">Spesifikasi Infrastruktur</span>
                </a>
            </li>
        </ul>
        <!-- end nav-tabs -->
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade active show" id="default-tab-1">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control selectpicker" name="sumber_dana_id" data-live-search="true" data-style="btn-warning" data-width="100%" readonly>
                        @php
                            $selected = '';
