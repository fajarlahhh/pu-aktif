	...
	<ul class="navbar-nav navbar-right">
		<li class="dropdown navbar-user">
			<a href="#" class="dropdown-toggle" data-toggle="dropdown">
				<img src="{{ url('/assets/img/user/user.png') }}" alt="" />
	...
	<script type="text/javascript">
		$("#btn-password").click(function(){
	    	$("#modal-password").load("{{ url('/gantisandi') }}");
	      	$.getScript("{{ url('/assets/plugins/bootstrap-show-password/dist/bootstrap-show-password.min.js') }}");
	      	$.getScript("{{ url('/assets/plugins/parsleyjs/dist/parsley.js') }}");
	  	});
	</script>
@endpush
