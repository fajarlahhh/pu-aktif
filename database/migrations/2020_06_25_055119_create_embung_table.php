...
class CreateEmbungTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('embung', function (Blueprint $table) {
            ...
            $table->decimal('embung_data_teknik_ca_km', 15, 2)->default(0);
            $table->decimal('embung_data_teknik_luasan_genangan', 15, 2)->default(0);
            $table->string('embung_data_teknik_tipe_konstruksi')->nullable();
            $table->decimal('embung_data_teknik_volume', 15, 2)->default(0);
            $table->decimal('embung_data_teknik_l', 15, 2)->default(0);
            $table->decimal('embung_data_teknik_h', 15, 2)->default(0);
            $table->decimal('embung_lebar_spillway', 15, 2)->default(0);
            $table->decimal('embung_fungsi_irigasi', 15, 2)->default(0);
            $table->decimal('embung_fungsi_ternak', 15, 2)->default(0);
            $table->decimal('embung_fungsi_air_baku', 15, 2)->default(0);
            $table->decimal('embung_fungsi_pltm', 15, 2)->default(0);
            $table->text('embung_tipe_keterangan')->nullable();
