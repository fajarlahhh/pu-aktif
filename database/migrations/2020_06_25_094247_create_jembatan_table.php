...
class CreateJembatanTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('jembatan', function (Blueprint $table) {
            ...
            $table->string('jembatan_bangunan_atas_tipe');
            $table->decimal('jembatan_bangunan_atas_kondisi', 15, 2)->default(0);
            $table->string('jembatan_bangunan_bawah_tipe');
            $table->decimal('jembatan_bangunan_bawah_kondisi', 15, 2)->default(0);
            $table->string('jembatan_bangunan_pondasi_tipe');
            $table->decimal('jembatan_bangunan_pondasi_kondisi', 15, 2)->default(0);
