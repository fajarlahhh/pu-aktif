...
class RekapperkabupatenkotaController extends Controller
{
    ...
    public function cetak(Request $req)
	{
        ...
        return view('layouts.print', [
            ...
            'laporan_pemeliharaan' => collect($laporan_pemeliharaan),
            'infrastruktur' => $infrastruktur,
            'judul' => '<h4>Rekap Per Kabupaten/Kota<br><small>Tahun '.$tahun.' '.($infrastruktur  == 'semua'? 'Semua Infrastruktur': $infrastruktur).', Sumber Dana : '.($dana  == 'semua'? 'Semua Sumber Dana': $sumber_dana->filter(function($q) use ($dana){
